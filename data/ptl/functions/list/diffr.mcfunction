...
execute store result score $ultimate temp run data get storage ptl:stdin List.Self[-1]
execute store result score $penultimate temp run data get storage ptl:stdin List.Self[-2]
scoreboard players operation $penultimate temp -= $ultimate var
