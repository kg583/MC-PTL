...
scoreboard players set $has_key temp 0
...
execute if score $has_key temp matches 0 run data modify storage ptl:stdout Map.Self append from storage ptl:stdin Map.Item
