...
data modify storage ptl:var Match set from storage ptl:stdin Set.Self
function ptl:set/or
execute store success score $diff var run data modify storage ptl:var Match set from storage ptl:stdout Set.Or
